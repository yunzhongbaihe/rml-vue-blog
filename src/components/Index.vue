<template>
  <div class="w1200 g_mt_20">
    <div id="printMe" class="g_flex" style="justify-content:space-between;align-items:flex-start;">
      <!-- 左侧 -->
      <div class="w800">
      ...
      <div class="w380">
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <p>{{profileData.username ? 'Hi，' + profileData.username : ''}}</p>
        ...
        <el-card class="g_bg_fff g_mt_20 card_reset my_card">
          <div class="contacts">
            ...
            <a href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&amp;email=940374606@qq.com" class="contacts_c2"
              title="我的邮箱" target="_blank"></a>
            <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=940374606&amp;site=qq&amp;menu=yes" class="contacts_c3" title="我的QQ"
              target="_blank"></a>
            <div class="c4_wrap">
              <Popover popover-class="my_card_c4_tip" arrow-style="left:auto;right:34px;" :popover-visible="popoverVisible">
                <img src="../../static/images/wx-qrcode.png" alt="" width="129" title="微信扫码加好友" />
              </Popover>
              <a href="javascript:void(0);" class="contacts_c4" title="我的微信" @mouseenter.stop="popoverVisible=true"
